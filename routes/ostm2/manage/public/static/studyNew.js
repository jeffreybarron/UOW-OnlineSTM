...
$(document).ready(function(){
	...
	$("#addRow").click(function(){
		var deckConfigTable = $("#deckConfigTable tbody")
	
		var markup = 
		'<tr>\n'  +
		'  <td>\n' + 
		'    <input type="text" class="form-control" name="order_' + iRowCount + '" value="' + iRowCount + '" readonly></input>\n' +
		'  </td>\n' + 
		'  <td>\n' + 
		'    <input type="text" class="form-control" name="deckName_' + iRowCount + '" required></input>\n' +
		'  </td>\n' + 
		'  <td>\n' + 
		'    <input type="text" class="form-control" name="setSizes_' + iRowCount + '" required></input>\n' +
		'  </td>\n' +  
		'  <td>\n' + 
		'    <input type="text" class="form-control" name="insideShuffle_' + iRowCount + '" required></input>\n' +
		'  </td>\n' + 
		'  <td>\n' + 
		'    <input type="text" class="form-control" name="crossShuffle_' + iRowCount + '" required></input>\n' +
		'  </td>\n' +
		'</tr>\n';

	  deckConfigTable.append(markup);
		iRowCount++;

		$("#deckConfigTable tbody tr:last").find('input:first').focus();
    ...
    $("#deckConfigTable tbody tr").each(function(){
        let col = []
				$( this ).find( 'input' ).each(function () {
					col.push("'" + this.name + "':'" + this.value + "'");
		...
		console.dir(dataArr);
		oStudyConfig["deckConfiguration"] = dataArr
