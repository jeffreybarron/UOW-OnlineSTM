...
window.addRow = function () {
  ...
  del.innerHTML = `
    <img class="icons insert" alt="insert" src="${siteAssets}images/iconfinder_table_row_insert_64776.png">
    <img class="icons trash" alt="trash-can" src="${siteAssets}images/trash_can_PNG18444.png">`;
...
window.createDeck = function () {
  ...
  xmlHttp.open("POST", moduleURL + "/deck/create/" + deckName.value, true);
...
$(document).on('click', 'img.insert', function () {
  ...
  let sNewRow = `
    <tr>
      ...
      <td>
        <img class="icons insert" alt="insert" src="${siteAssets}images/iconfinder_table_row_insert_64776.png">
        <img class="icons trash" alt="trash-can" src="${siteAssets}images/trash_can_PNG18444.png"></td>
    </tr>`
